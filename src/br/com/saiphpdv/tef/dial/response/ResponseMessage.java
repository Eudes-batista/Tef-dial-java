 ...
 */
package br.com.saiphpdv.tef.dial.response;

import br.com.saiphpdv.tef.AdicionaNomeCartao;
import br.com.saiphpdv.tef.misc.Parcel;
import br.com.saiphpdv.tef.dial.TefDial;
import br.com.saiphpdv.tef.misc.ParcelingType;
...
public class ResponseMessage implements java.io.Serializable {
    ...
    protected String nameCardTransaction;       //711-001       NOME DO CARTÃO
    //CIELO
...
//    protected boolean printed = false;
    ...
    /**
     * Nome do cartão capiturado pelo gerenciador do tef
     *
     * @return
     */
    public String getNameCardTransaction() {
     ...
     * Nome do cartão capiturado pelo gerenciador do tef
     *
     * @param nameCardTransaction
     */
    public void setNameCardTransaction(String nameCardTransaction) {
        this.nameCardTransaction = nameCardTransaction;
    }
    ...
    protected final void setValue(String field, String value) {
        ...
        switch (field) {
            ...
            case "011":
                ...
                this.nameCardTransaction = AdicionaNomeCartao.getAdicionaNomeCartao(this.nameCardTransaction, this.network).addNameCard(this.transactionType);
                break;
            case "012":
