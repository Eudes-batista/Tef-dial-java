...
import br.com.saiphpdv.tef.dial.Constants;
 ...
 */
public class CNC extends DispatchMessage {
    ...
    public CNC() {
        operation = TefDial.Operation.CNC;
    }
    ...
    protected void writeFields(StringBuilder sb) {
        ...
        sb.append("022-000").append(Constants.EQUAL).append(transactionTimestamp.toString("ddMMyyyy")).append(Constants.CR_LF);
        sb.append("023-000").append(Constants.EQUAL).append(transactionTimestamp.toString("HHmmss")).append(Constants.CR_LF);
        sb.append("028-000").append("").append(Constants.CR_LF);
